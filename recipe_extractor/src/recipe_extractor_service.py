...
class RecipeExtractorDbusService:
    SERVICE_NAME = "vn.edu.uit.FSS.RecipeExtractor"
    OBJECT_PATH = "/vn/edu/uit/FSS/RecipeExtractor"
    INTERFACE_NAME = "vn.edu.uit.FSS.RecipeExtractor"
    ...
    def __init__(self, nlp_engine=None):
        ...
        if SDBUS_AVAILABLE:
            self.logger.info("RecipeExtractorDbusService initialized (sdbus available)")
        else:
...
if SDBUS_AVAILABLE:
    class RecipeExtractorDbusObject(
        DbusInterfaceCommonAsync,
        interface_name="vn.edu.uit.FSS.RecipeExtractor"
    ):
        def __init__(self):
        ...
        def set_service_instance(self, instance: RecipeExtractorDbusService):
    ...
    class RecipeExtractorDbusObject(ABC):
